...
Public Class FilterPolygonVertices
    Inherits GH_Component
    ''' <summary>
    ''' Initializes a new instance of the NakedPolygonVertices class.
    ''' </summary>
    Public Sub New()
        MyBase.New("Filter Polygon Vertices", "FPolyV", _
    ...
    Protected Overrides Sub RegisterInputParams(ByVal pManager As GH_Component.GH_InputParamManager)
        ...
        pManager.AddIntegerParameter("Face count", "C", "Number of adjacent faces to vertex", GH_ParamAccess.item, 1)
    End Sub
    ...
    Protected Overrides Sub RegisterOutputParams(ByVal pManager As GH_Component.GH_OutputParamManager)
        pManager.AddTextParameter("ID", "A", "Naked point IDs", GH_ParamAccess.list)
        pManager.AddPointParameter("Naked", "D", "Naked points", GH_ParamAccess.list)
    End Sub
